...
const LGBM_LOGO=`data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path d="M24 4L8 20h10v24h12V20h10z" fill="%23E84E40" opacity="0.85"/><path d="M14 12L4 28h7v16h8V28h7z" fill="%2366BB6A" opacity="0.8"/><path d="M34 12l10 16h-7v16h-8V28h-7z" fill="%2342A5F5" opacity="0.8"/></svg>')}`;
...
const PConfig = ({cfg,set}) => (<>
  ...
  <Sec title="Feature-Selektion">
    ...
    {cfg.fsEnabled&&<>
      <Divider/>
      <div style={{fontSize:13.5,fontWeight:600,color:C.dark,marginBottom:10}}>1. Methoden auswählen</div>
      ...
      <Divider/>
      <div style={{fontSize:13.5,fontWeight:600,color:C.dark,marginBottom:10}}>2. Parameter</div>
      <Row>
    ...
    <div style={{display:"flex",minHeight:"100vh",fontFamily:"'DM Sans',system-ui,-apple-system,sans-serif",fontSize:15,color:"#24292f",background:"#faf7f8"}}>
      <nav style={{width:280,minWidth:280,background:"linear-gradient(180deg,#4a080f 0%,#6B0D15 30%,#8a0f1a 100%)",color:"#fff",position:"sticky",top:0,height:"100vh",overflowY:"auto",flexShrink:0,display:"flex",flexDirection:"column",boxShadow:"4px 0 24px rgba(107,13,21,0.15)"}}>
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",padding:"20px 20px 10px"}}>
          <div style={{background:"rgba(255,255,255,0.05)",borderRadius:20,padding:"12px 20px 9px",border:"1px solid rgba(255,255,255,0.06)"}}>
            <RubinLogo size={52} light/>
            <h1 style={{fontSize:22,fontWeight:700,margin:"5px 0 0",letterSpacing:1.5,textAlign:"center"}}>rubin</h1>
          </div>
