...
const LGBM_LOGO="data:image/png;base64,";
  ...
  <>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(5, 1fr)",gap:10,marginBottom:26}}>
      {[
        ...
        {v:"18",l:"Vorlagen",d:"8 BT + 3 MT + 7 Add-ons",accent:"#6366f1"},
      ].map(c => (
      ...
      <nav style={{width:280,minWidth:280,background:"linear-gradient(180deg,#4a080f 0%,#6B0D15 30%,#8a0f1a 100%)",color:"#fff",position:"sticky",top:0,height:"100vh",overflowY:"auto",flexShrink:0,display:"flex",flexDirection:"column",boxShadow:"4px 0 24px rgba(107,13,21,0.15)"}}>
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",padding:"24px 20px 14px"}}>
          <div style={{background:"rgba(255,255,255,0.05)",borderRadius:20,padding:"14px 22px 10px",border:"1px solid rgba(255,255,255,0.06)"}}>
            <RubinLogo size={56} light/>
            <h1 style={{fontSize:24,fontWeight:700,margin:"6px 0 0",letterSpacing:1.5,textAlign:"center"}}>rubin</h1>
          </div>
          <p style={{fontSize:11,opacity:0.4,margin:"4px 0 0",letterSpacing:0.8}}>Causal ML Framework</p>
        </div>
        ...
        <div style={{flex:1,padding:"0 6px"}}>
          {pages.map((p,idx) => {
            ...
            return (
              <div key={p.key}>
                {showGroup && <div style={{fontSize:9,fontWeight:600,textTransform:"uppercase",letterSpacing:"1px",color:"rgba(255,255,255,0.2)",padding:"8px 20px 2px",marginTop:0}}>{p.group}</div>}
                <button onClick={()=>setPg(p.key)} style={{display:"flex",alignItems:"center",gap:8,width:"100%",textAlign:"left",padding:"7px 18px",background:active?"rgba(255,255,255,0.12)":"transparent",color:active?"#fff":"rgba(255,255,255,0.6)",border:"none",borderLeft:active?"3px solid rgba(255,255,255,0.85)":"3px solid transparent",borderRadius:active?"0 6px 6px 0":"0",cursor:"pointer",fontSize:13,fontWeight:active?600:400,fontFamily:"inherit",transition:"all 0.15s",letterSpacing:0.2,marginBottom:0}}
